package JavaRockStarTeam;

public class NumCountriesStored09 {
	...
	public static void main(String[] args) {
		...
		String[][] contries = { { "USA", "Canada", "Mexico" }, { "Argentina", "Brasil", "Peru" },
				{ "France", "England", "Russia" }, { "Korea", "Japan", "Kazakhstan" },
